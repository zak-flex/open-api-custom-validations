...
import sk.matusko.tutorial.openapicustomvalidations.model.Error;
...
public interface PetsApi {
    ...
    default ResponseEntity<Void> createPets(@ApiParam(value = "" ,required=true )  @Valid @RequestBody Pet pet) {
    ...
    default ResponseEntity<List<Pet>> listPets(@NotNull @EvenLong

@ApiParam(value = "How many items to return at one time (max 100)", required = true) @Valid @RequestParam(value = "limit", required = true) Long limit) {
